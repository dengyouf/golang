...
func TestTypeOf(t *testing.T) {
	...
	var a Age = 10
	var b int = 20
	fmt.Println(reflect.TypeOf(a)) //basic.Age
...
func TestAtoiErr(t *testing.T) {
	i, err := strconv.Atoi("100x")
	fmt.Printf("type %v, value: %d, err: %v\n-",
		reflect.TypeOf(i), i, err)
	//type int, value: 0, err: strconv.Atoi: parsing "100x": invalid
}
...
func TestFloat1(t *testing.T) {
	...
	fmt.Println(n) // 9.999999999999831
}
